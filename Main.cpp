/**************************************************************************************************************************************************
 ...
 Purpose:	This program allows the user to construct a console window to a specific size based on characters in a row and in a column as well as
            adjust the size of a character in pixels and select a font to use in the console.
            Available Font List:
...
void ConstructConsole(int width, int height, int fontW, int fontH, string fontName)
{
    int screenWidth = 0;
    int screenHeight = 0;
...
int main()
{
    ConstructConsole(60, 30, 8, 16, "MS Gothic");
